...
<div className={classes.root} style={{width:"50rem"}}>
      ...
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          id="panel3a-header"
        >
          <Typography className={classes.heading}>What are MoTo Workspaces?</Typography>
          </ExpansionPanelSummary>
        <ExpansionPanelDetails>
          <Typography>
          MoTo WorkSpaces are virtual automobile stations streamed to users with live updates.
          </Typography>
        </ExpansionPanelDetails>
      </ExpansionPanel>
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          id="panel3a-header"
        >
          <Typography className={classes.heading}>Is MoTo only bound to Automobile?</Typography>
          </ExpansionPanelSummary>
        <ExpansionPanelDetails>
          <Typography>
          Absolutely no!. We are providing individual workspaces for companies that requires 
          tracking of their assets.
          </Typography>
        </ExpansionPanelDetails>
      </ExpansionPanel>
      <ExpansionPanel>
        <ExpansionPanelSummary
          ...
          id="panel3a-header"
        >
          <Typography className={classes.heading}>Feature Updates of MoTo?</Typography>
          </ExpansionPanelSummary>
        <ExpansionPanelDetails>
          <Typography>
